...
The results show that the neural network is by far the fastest method (around two-three times faster than FFT), at the cost of a higher mean error and larger error variance.
